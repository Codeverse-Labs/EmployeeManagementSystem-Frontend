    ...
    <div class="flex flex-col p-10 w-96">
        <form class="mt-8 space-y-6" @submit.prevent="submit" method="POST">
            ...
            <div class="-space-y-px rounded-md shadow-sm">
                <div>
                    <label for="day" class="block text-sm font-medium text-gray-500 text-left">Leave Date</label>
                    <input id="day" name="day" type="date" v-model="leave.day" autocomplete="day" required
                ...
                <div>
                    <label for="isFullday" class="block text-sm font-medium text-gray-500 text-left">Leave Duration</label>
                    <select name="isFullday" id="isFullday" v-model="leave.isFullday" required
                        class="relative block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm mb-2">
                        <option value=null>Leave Duration*</option>
