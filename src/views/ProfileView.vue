      ...
      <div class="mt-20 border-b pb-12">
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div class=" text-left">
            ...
            <h1 class="text-base font-medium text-gray-700" v-if="userState.user.designation.name">{{
              userState.user.designation.name }} </h1>
            <h1 class="text-base font-medium text-gray-700" v-else>-</h1>
          </div>

          <div class=" text-left">
            <h1 class=" text-xs font-medium text-gray-400">Birthday</h1>
            <h1 class="text-base font-medium text-gray-700" v-if="userState.user.dob">{{ formatDate(userState.user.dob) }}
            </h1>
            <h1 class="text-base font-medium text-gray-700" v-else>-</h1>
          </div>
          ...
          <div class=" text-left">
            ...
            <h1 class="text-base font-medium text-gray-700" v-if="userState.user.reportPerson.name">{{
              userState.user.reportPerson.name }} </h1>
            <h1 class="text-base font-medium text-gray-700" v-else>-</h1>
          </div>

          <div class=" text-left">
            <h1 class=" text-xs font-medium text-gray-400">Adderss</h1>
            <h1 class="text-base font-medium text-gray-700" v-if="userState.user.address">{{ userState.user.address }}
            </h1>
            <h1 class="text-base font-medium text-gray-700" v-else>-</h1>
          </div>
        </div>
